...
beam_sizes = [1, 2, 5, 10, 50, 100, 200, 500, 1000, 2500, 5000, 10000]
...
fig_big, ax_big = plt.subplots(
    3, 3, figsize=(12, 35), sharex="all", sharey="all", layout="constrained"
)
...
fig_big.savefig("figures/boxplots/ag_news_all_increasing_beam_sizes.pdf", format="pdf")
