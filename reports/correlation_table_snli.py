...
model_dict = {
    'textattack/bert-base-uncased-snli': 'BERT$_{\\text{SNLI}}$',
    'textattack/distilbert-base-cased-snli': 'RoBERTa$_{\\text{SNLI}}$',
    'varun-v-rao/gpt2-snli-model1': 'GPT-2$_{\\text{SNLI}}$',
}
