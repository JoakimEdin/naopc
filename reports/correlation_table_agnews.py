...
model_dict = {
    "textattack/distilbert-base-uncased-ag-news": "DistillBERT$_{\\text{AG News}}$",
    "textattack/bert-base-uncased-ag-news": "BERT$_{\\text{AG News}}$",
    "textattack/roberta-base-ag-news": "RoBERTa$_{\\text{AG News}}$",
}
